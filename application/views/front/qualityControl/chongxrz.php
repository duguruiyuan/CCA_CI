...
<div class="content_pgu">
    ...
    <div>
        ...
        <table style="width:100%;padding:20px;text-align:center;background:#83A3D5;height:600px;">
           ...
           <tr style="line-height:20px;"  >
            <td style="text-align:left;padding-left:40px" colspan="2">请选择目前实际开展的再灌注治疗方法（至少选择一个，已经开展的必须选择）: <input type="checkbox" value="0" >溶栓<input type="checkbox" value="1">转运PPCI<input type="checkbox" value="2">本院PPCI
  ...
  <script type="text/javascript">
    ...
    $(function(){
      ...
      $value2 = $('input[name=radio2]:checked').val();

      $value3 = $('input[name=radio3]:checked').val();
