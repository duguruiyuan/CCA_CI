...
<body>
 <input  style=" margin-left:30%; margin-top:5%; font-size:16px; background:#4BCCF6" type="button" value="机构会员注册" onclick="showDiv('jigou')"/>
 <input type="button" value="个人会员注册" style="  margin-left:10%; font-size:16px;  background:#4BCCF6" onclick="showDiv('personal')"/>
